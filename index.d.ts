...
// export const Widget: React.ElementType;
...
export function renderCustomComponent(component: React.ElementType, props: any): void;
export function renderCustomComponent(component: React.ElementType, props: any, showAvatar: boolean): void;
export function renderCustomComponent(component: React.ElementType, props: any, showAvatar: boolean, id: string): void;
